    ...
    <div className="bg-soft-gray min-h-screen pt-20 pb-20">
      <div className="max-w-4xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 bg-white p-12 shadow-sm border border-gray-100">
        ...
        <div className="space-y-8">
          <h1 className="text-3xl font-serif text-marine-blue tracking-widest uppercase">{t.contact.heroTitle}</h1>
        ...
        <div className="space-y-8">
          <h2 className="text-xl font-serif text-marine-blue tracking-widest uppercase">{t.contact.openingHours}</h2>
          <div className="font-sans text-sm text-gray-600 space-y-2">
            <div className="flex justify-between border-b border-gray-100 pb-2"><span>{t.footer.days.mon}</span> <span>16:00 – 00:00</span></div>
            <div className="flex justify-between border-b border-gray-100 pb-2"><span>{t.footer.days.tue}</span> <span>16:00 – 00:00</span></div>
            <div className="flex justify-between border-b border-gray-100 pb-2"><span>{t.footer.days.wed}</span> <span>16:00 – 00:00</span></div>
            <div className="flex justify-between border-b border-gray-100 pb-2"><span>{t.footer.days.thu}</span> <span>16:00 – 00:00</span></div>
            <div className="flex justify-between border-b border-gray-100 pb-2"><span>{t.footer.days.fri}</span> <span>12:00 – 00:00</span></div>
            <div className="flex justify-between border-b border-gray-100 pb-2"><span>{t.footer.days.sat}</span> <span>12:00 – 00:00</span></div>
            <div className="flex justify-between border-b border-gray-100 pb-2"><span>{t.footer.days.sun}</span> <span>12:00 – 00:00</span></div>
          </div>
        </div>
